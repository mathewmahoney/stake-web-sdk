...
export default {
	...
	symbols: {
		type: 'spine',
		src: {
			skeleton: `https://test-twist-front-2.s3.ap-southeast-2.amazonaws.com/1-20-festive-frost/spines/symbols/symbols.json`,
			atlas: `https://test-twist-front-2.s3.ap-southeast-2.amazonaws.com/1-20-festive-frost/spines/symbols/symbols.atlas`,
			scale: 2,
		},
	},
	reelsFrame: {
	...
	specialSymbolsStatic: {
		type: 'sprites',
		src: `https://test-twist-front-2.s3.ap-southeast-2.amazonaws.com/1-20-festive-frost/sprites/symbols-static/symbols-static.json`,
	},
	coins: {
		type: 'spriteSheet',
