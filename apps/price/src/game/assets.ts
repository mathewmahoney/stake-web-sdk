export default {
	...
	specialSymbolsStatic: {
		type: 'sprites',
		src: new URL('../../assets/sprites/symbols-static/symbols-static.json', import.meta.url).href,
	},
	symbols: {
		type: 'spine',
		src: {
			skeleton: new URL('../../assets/spines/symbolsSpecial/symbols.json', import.meta.url).href,
			atlas: new URL('../../assets/spines/symbolsSpecial/symbols.atlas', import.meta.url).href,
			scale: 2,
		},
	},
} as const;
